...
import { invoiceSchema, lineSchema } from '../src';

describe('Invoice Lines', () => {
    it('should have property "invoiceLine"', () => {
        const { invoiceLines, ...theRest } = basicInvoice;
    ...
    it('should have at least 1 line item', () => {
        const sampleInvoice1 = { ...basicInvoice };
        const sampleInvoice2 = { ...basicInvoice };

        sampleInvoice1.invoiceLines = [];

        const result1 = invoiceSchema.safeParse(sampleInvoice1);
        const result2 = invoiceSchema.safeParse(sampleInvoice2);
    ...
    it('should return success if the lines include only required fields', () => {
        ...
        const result1 = lineSchema.safeParse(invoiceLines);
