/**
 * ICD (ISO 6523) codes used for Party Identification in PEPPOL BIS 3.0.
 * These identify the scheme used for party identifiers (cac:PartyIdentification/cbc:ID).
 * Note: SEPA is allowed for bank-assigned creditor identifiers (BT-90).
...
export const ICDCodes = {
    ...
    '9901': 'Bank Account Number',
    '9906': 'National Organization Identifier Register (NOIR)',
    '9907': 'Organisationsnummer',
    '9908': 'Organisationsnummer',
    '9909': 'Standard Company Code',
    '9910': 'Hungary VAT number',
    '9911': 'Andorra VAT number',
    '9912': 'Albania VAT number',
    ...
    '9921': 'EDICAT IVA – VIES (VAT Identification)',
    ...
    '9954': 'Swedish VAT number',
    '9955': 'French VAT number',
    '9956': 'French SIRET number',
    '9957': 'French VAT number',
    '9958': 'Spanish VAT number',
    '9959': 'Employer Identification Number (EIN, USA)',
    '9960': 'Denmark VAT number',
    '9970': 'Ukraine VAT number',
    SEPA: 'Bank assigned creditor identifier (SEPA)',
} as const;

export type ICDCode = keyof typeof ICDCodes;

/**
 * Check if a given code is a valid ICD code
 * @param code The code to check
 */
export function isValidICDCode(code: string): code is ICDCode {
    return code in ICDCodes;
}

const icdCodeKeys = Object.keys(ICDCodes) as unknown as [ICDCode, ...ICDCode[]];
export const ICDCodeSchema = z.enum(icdCodeKeys);
