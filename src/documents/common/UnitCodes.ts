/**
 * Unit of measure codes based on UN/ECE Recommendation No. 20
 * These codes identify units of measurement used in commercial transactions
...
export type UnitCode = keyof typeof UnitCodes;

/**
 * Get the description of a unit code
 * @param code The unit code to get the description for
 * @returns The description of the unit code
 */
export function getUnitDescription(code: UnitCode): string {
    return UnitCodes[code];
}

/**
 * Check if a given code is a valid unit code
 * @param code The code to check
 */
export function isValidUnitCode(code: string): code is UnitCode {
    return code in UnitCodes;
}

// Zod schema for unit codes
const unitCodeKeys = Object.keys(UnitCodes) as unknown as [
    UnitCode,
    ...UnitCode[],
];
export const UnitCodeSchema = z.enum(unitCodeKeys);
