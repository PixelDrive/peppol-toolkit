/**
 * Currency codes as defined by ISO 4217
...
/**
 * Get the description of a currency code
 * @param code The currency code to get the description for
 * @returns The description of the currency code
 */
export function getCurrencyDescription(code: CurrencyCode): string {
    return CurrencyCodes[code];
}

/**
 * Check if a given code is a valid currency code
